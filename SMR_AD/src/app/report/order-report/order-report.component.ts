...
export class OrderReportComponent implements OnInit {
  ...
  orderPreviewData: ReportPoHhkGroupedDto[] = [];
  ...
  onPreview(): void {
    ...
    this.reportService.getOrderReport(filterDto).subscribe({
      next: (data) => {
        this.isLoadingPreview = false;
        
        if (data && Array.isArray(data)) {
          this.orderPreviewData = data;
