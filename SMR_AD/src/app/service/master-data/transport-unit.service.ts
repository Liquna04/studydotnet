...
export class TransportUnitService {
  ...
  search(params: any): Observable<any> {
    return this.commonService.get('TransportUnit/Search', params);
  }

  getAll(): Observable<any> {
    return this.commonService.get('TransportUnit/GetAll');
  }

    create(params: any): Observable<ApiResponse<any>> {
      const url = `${environment.apiUrl}/TransportUnit/Insert`;
      return this.http.post<ApiResponse<any>>(url, params);
    }
      update(params: any): Observable<ApiResponse<any>> {
      const url = `${environment.apiUrl}/TransportUnit/Update`;
