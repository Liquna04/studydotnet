...
export class UnitProductComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private _service: UnitProductService,
    ...
    this.globalService.setBreadcrumb([
      { name: 'Danh sách đơn vị tính', path: 'master-data/unit-product' },
    ]);
