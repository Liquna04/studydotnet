...
import { UnloadPointService } from '../../service/master-data/unload-point.service';
...
@Component({
  ...
  styleUrls: ['./unload-point.component.scss'],
})
export class UnloadPointComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private _service: UnloadPointService,
    ...
    this.globalService.setBreadcrumb([
      { name: 'Danh sách điểm trả hàng', path: 'master-data/unload-point' },
    ]);
