...
namespace DMS.API.Controllers.AD
{
    ...
    [ApiController]
    public class AccountStoreController(IAccountStoreService service) : ControllerBase
    {
        public readonly IAccountStoreService _service = service;
        ...
        public async Task<IActionResult> Search([FromQuery] BaseFilter filter)
        {
            ...
            var data = result.Data as List<AccountStoreDto>;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Create([FromBody] AccountStoreDto data)
        {
            var transferObject = new TransferObject();
