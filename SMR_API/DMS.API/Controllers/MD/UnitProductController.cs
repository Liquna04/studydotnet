...
namespace DMS.API.Controllers.MD
{
    ...
    [ApiController]
    [Authorize]
    public class UnitProductController(IUnitProductService service) : ControllerBase
    {
        public readonly IUnitProductService _service = service;
        ...
        public async Task<IActionResult> Insert([FromBody] UnitProductDto data)
        {
            var transferObject = new TransferObject();
        ...
        public async Task<IActionResult> Update([FromBody] UnitProductDto data)
        {
            var transferObject = new TransferObject();
