...
namespace DMS.API.Controllers.MD
{
    ...
    [ApiController]
    [Authorize]
    public class ProductList(IProductListService service) : ControllerBase
    {
        public readonly IProductListService _service = service;
        ...
        public async Task<IActionResult> Insert([FromBody] ProductListCreateUpdateDto data)
        {
            var transferObject = new TransferObject();
        ...
        public async Task<IActionResult> Update([FromBody] ProductListCreateUpdateDto data)
        {
            var transferObject = new TransferObject();
